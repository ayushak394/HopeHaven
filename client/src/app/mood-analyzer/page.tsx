        ...
        <div className="max-w-5xl mx-auto">
          ...
          {insights &&
            (parsedInsights ? (
              ...
              >
                ...
                <div className="flex justify-center">
                  <Button
                    ...
                    className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-6 text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                  >
              ...
              <Card className="border-0 bg-gradient-to-br from-purple-50/80 to-pink-50/80 backdrop-blur-sm mb-8 shadow-lg animate-fade-in">
                <CardContent className="p-8">
