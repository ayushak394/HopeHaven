...
export default function JournalPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-linear-to-br from-coral-50 via-purple-50 to-blue-50 flex items-center justify-center">
          ...
          <Card className="w-full max-w-md border-0 bg-white/90 backdrop-blur-xl shadow-2xl animate-scale-in">
            <CardHeader className="text-center pb-4">
              <div className="flex justify-center mb-4">
                <div className="p-4 bg-linear-to-br from-coral-400 to-purple-500 rounded-2xl shadow-lg">
                  <Lock className="w-12 h-12 text-white" />
                </div>
              </div>
              <CardTitle className="text-3xl">
                <span className="bg-linear-to-r from-coral-500 to-purple-500 bg-clip-text text-transparent">
                  Journal Locked
                </span>
              </CardTitle>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                <Button
                  ...
                  className="w-full bg-linear-to-r from-coral-500 to-purple-500 hover:from-coral-600 hover:to-purple-600 text-white py-6 text-lg rounded-xl transition-all duration-300 hover:scale-[1.02] hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
                >
                  {verifying ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex gap-3">
                        <Button
                          ...
                          size="lg"
                          className="flex-1 bg-linear-to-r from-coral-500 to-coral-600 hover:from-coral-600 hover:to-coral-700 text-white py-6 text-lg rounded-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed font-semibold"
                        >
                          {submitting ? (
                            <span className="flex items-center gap-2">
                              <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
                  ...
                  {journalEntries.length > 0 ? (
                    <div className="max-h-[800px] overflow-y-auto space-y-4 pr-2 custom-scrollbar">
                      {journalEntries.map((entry, index) => (
                        <div
                          key={entry.id}
                          className="group p-6 bg-linear-to-br from-white to-gray-50/50 rounded-2xl border-2 border-gray-100 hover:border-coral-200 hover:shadow-lg transition-all duration-300 animate-fade-in relative overflow-hidden"
                          style={{ animationDelay: `${index * 50}ms` }}
                        >
                          <div className="absolute inset-0 bg-linear-to-r from-coral-50/0 via-coral-50/50 to-coral-50/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
