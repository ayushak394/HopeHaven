        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3 group cursor-pointer" onClick={() => router.push("/home")}>
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-coral-500 to-pink-500 rounded-full blur-md opacity-50 group-hover:opacity-75 transition-opacity" />
      ...
      <section className="py-20 px-4 sm:px-6 relative">
        <div className="max-w-4xl mx-auto">
          <Card className="border-0 bg-white/80 backdrop-blur-xl shadow-2xl overflow-hidden relative">
            <div className="absolute inset-0 bg-gradient-to-br from-coral-500/5 via-purple-500/5 to-blue-500/5" />

            <CardContent className="p-8 sm:p-12 text-center relative z-10">
              <div className="relative inline-block mb-6">
                <div className="absolute inset-0 bg-gradient-to-r from-coral-500 to-purple-500 rounded-full blur-2xl opacity-30 animate-pulse-gentle" />
                <div className="relative w-20 h-20 bg-gradient-to-br from-coral-500 via-pink-500 to-purple-500 rounded-full flex items-center justify-center mx-auto shadow-xl">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed mb-8">
                Start by checking in with your mood. It only takes a few seconds and helps us provide better support.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <Button
                  size="lg"
                  className="relative bg-gradient-to-r from-coral-500 via-pink-500 to-purple-500 hover:from-coral-600 hover:via-pink-600 hover:to-purple-600 text-white px-10 py-6 text-lg rounded-full transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-lg overflow-hidden group"
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="px-10 py-6 text-lg rounded-full border-2 border-slate-300 hover:border-slate-400 bg-white hover:bg-slate-50 transition-all duration-300 hover:scale-105 font-semibold hover:shadow-lg"
