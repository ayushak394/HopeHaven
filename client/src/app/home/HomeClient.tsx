...
//           <Card className="border-0 bg-linear-to-br from-coral-50 via-pink-50 to-purple-50 shadow-2xl overflow-hidden relative group hover:shadow-3xl transition-all duration-500">
...
//                     When things feel overwhelming, guided breathing exercises can help calm your mind and body. Take a moment for yourself right now.
//                   </p>

//                   <Button
//                     size="lg"
//                     className="relative bg-gradient-to-r from-coral-500 via-pink-500 to-purple-500 hover:from-blue-600 hover:via-pink-500 hover:to-purple-500 text-white px-10 py-6 text-lg rounded-full transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-lg overflow-hidden group/btn"
...
//                     </span>
//                     <div className="absolute inset-0 bg-gradient-to-r from-cyan-500 to-teal-500 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300" />
//                   </Button>
//                 </div>
