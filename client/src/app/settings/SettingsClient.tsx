...
type Theme = "light" | "calm-blue" | "sunset-orange" | "lavender";
                    ...
                    <div>
                      ...
                      {isEditingName ? (
                        ...
                        <div className="flex items-center gap-3 p-4 bg-linear-to-r from-coral-50/80 to-pink-50/80 rounded-xl border-2 border-coral-100">
                          <span className="text-2xl font-bold text-foreground flex-1">
                            {displayName}
                          </span>
                          <Button
                            variant="outline"
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="p-4 bg-blue-50/50 rounded-xl border border-blue-200">
                      <p className="text-xs text-blue-700/80 leading-relaxed">
                        When enabled, you'll need to enter your passcode before
                        viewing journal entries. This keeps your private
                        thoughts secure.
                      </p>
                    </div>
                  </div>
                ...
                <CardHeader className="border-b border-red-200/50 relative pb-6">
                  <CardTitle className="flex items-center gap-3 text-red-800">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-700/70 font-normal mt-1">
                        Manage your session
                      </p>
                    </div>
                  </CardTitle>
              ...
              <Card>
                <CardContent className="pt-8 relative w-full h-full">
                  <div className="space-y-4 w-full h-full">
                    <div className="p-6 w-full h-full bg-white/80 backdrop-blur-sm rounded-2xl border-2 border-red-300/50 hover:border-red-400 transition-all duration-300 hover:shadow-lg flex flex-col justify-between">
